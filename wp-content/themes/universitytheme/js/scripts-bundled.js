...
var _MyNotes = _interopRequireDefault(__webpack_require__(12));

var _Like = _interopRequireDefault(__webpack_require__(13));
...
var notes = new _MyNotes.default();
...
var _GeneralInfo = _interopRequireDefault(__webpack_require__(7));

var _Programs = _interopRequireDefault(__webpack_require__(8));

var _Campuses = _interopRequireDefault(__webpack_require__(9));

var _Professors = _interopRequireDefault(__webpack_require__(10));

var _Events = _interopRequireDefault(__webpack_require__(11));
...
function () {
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON("".concat(universityData.root_url, "/wp-json/university/v1/search?term=").concat(this.searchField.val()), function (results) {
        _this.resultsDiv.html("\n                    <div class=\"row\">\n                        <div class=\"one-third\">\n                            <h2 class=\"search-overlay__section-title\">\n                                General Information\n                            </h2>\n                            ".concat((0, _GeneralInfo.default)(results.generalInfo), "\n                        </div>\n                        <div class=\"one-third\">\n                            <h2 class=\"search-overlay__section-title\">\n                                Programs\n                            </h2>\n                            ").concat((0, _Programs.default)(results.programs), "\n                            <h2 class=\"search-overlay__section-title\">\n                                Professors\n                            </h2>\n                            ").concat((0, _Professors.default)(results.professors), "\n                        </div>\n                        <div class=\"one-third\">\n                            <h2 class=\"search-overlay__section-title\">\n                                Campuses\n                            </h2>    \n                            ").concat((0, _Campuses.default)(results.campuses), "\n                            <h2 class=\"search-overlay__section-title\">\n                                Events\n                            </h2>\n                            ").concat((0, _Events.default)(results.events), "\n                        </div>\n                    </div>\n                "));
...
var _default = function _default(generalInfo) {
  return generalInfo.length > 0 ? "<ul class=\"link-list min-list\"> \n            ".concat(generalInfo.map(function (item) {
    return "\n                    <li>\n                        <a href=\"".concat(item.permalink, "\">").concat(item.title, "</a> ").concat(item.postType == 'post' ? "by ".concat(item.authorName) : '', "\n                    </li>\n                ");
  }).join(''), "\n            </ul>") : "<p>No general information matches that search. <a href=\"".concat(universityData.root_url, "/blog\">View all Posts.</a></p>");
};
...
var _default = function _default(programs) {
  return programs.length > 0 ? "<ul class=\"link-list min-list\"> \n            ".concat(programs.map(function (item) {
    return "\n                    <li>\n                        <a href=\"".concat(item.permalink, "\">").concat(item.title, "</a>\n                    </li>\n                ");
  }).join(''), "\n            </ul>") : "<p>No programs match that search. <a href=\"".concat(universityData.root_url, "/programs\">View all Programs.</a></p>");
};
...
var _default = function _default(campuses) {
  return campuses.length > 0 ? "<ul class=\"link-list min-list\"> \n            ".concat(campuses.map(function (item) {
    return "\n                    <li>\n                        <a href=\"".concat(item.permalink, "\">").concat(item.title, "</a>\n                    </li>\n                ");
  }).join(''), "\n            </ul>") : "<p>No campuses match that search. <a href=\"".concat(universityData.root_url, "/campuses\">View all Campuses.</a></p>");
};
...
var _default = function _default(professors) {
  return professors.length > 0 ? "<ul class=\"professor-cards\"> \n            ".concat(professors.map(function (item) {
  ...
  }).join(''), "\n            </ul>") : "<p>No professors match that search.</p>";
};
...
var _default = function _default(events) {
  return events.length > 0 ? "".concat(events.map(function (item) {
  ...
  }).join('')) : "<p>No events match that search. <a href=\"".concat(universityData.root_url, "/campuses\">View all Events.</a></p>");
};
  ...
  _createClass(MyNotes, [{
    ...
    value: function deleteNote(e) {
      ...
      _jquery.default.ajax({
        ...
        url: universityData.root_url + "/wp-json/wp/v2/note/".concat(thisNote.data('id')),
        type: 'DELETE',
        success: function success(res) {
          thisNote.slideUp();
...
function () {
  function Like() {
    ...
    this.likeBox = (0, _jquery.default)('.like-box');
    this.events();
  }
